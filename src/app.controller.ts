...
export class AppController {
  ...
  getSecrets(): Record<string, string> {
    const secrets = {
      codeclimate: this.appService.getSecret('CODECLIMATE_REPO_TOKEN'),
      facebook: this.appService.getSecret('FACEBOOK_TOKEN'),
      google_b64: this.appService.getSecret('GOOGLE_B64'),
      google_oauth: this.appService.getSecret('GOOGLE_OAUTH'),
      google_oauth_token: this.appService.getSecret('GOOGLE_OAUTH_TOKEN'),
      heroku: this.appService.getSecret('HEROKU_TOKEN'),
      hockey_app: this.appService.getSecret('HOCKEY_APP_TOKEN'),
      outlook: this.appService.getSecret('OUTLOOK_TOKEN'),
      paypal: this.appService.getSecret('PAYPAL_TOKEN'),
      slack: this.appService.getSecret('SLACK_TOKEN')
    };
    return secrets;
  }
